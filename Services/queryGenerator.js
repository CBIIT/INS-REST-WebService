...
queryGenerator.getSearchQueryV2 = (searchText, filters, options) => {
  ...
  body.highlight = {
    ...
    fields: {
      ...
      'dataset_maximum_age_at_baseline': { number_of_fragments: 0 },
      'dataset_minimum_age_at_baseline': { number_of_fragments: 0 },
      'dataset_source_id': { number_of_fragments: 0 },
      'dataset_source_repo': { number_of_fragments: 0 },
      'dataset_source_url': { number_of_fragments: 0 },
      'dataset_year_enrollment_ended': { number_of_fragments: 0 },
      'dataset_year_enrollment_started': { number_of_fragments: 0 },
